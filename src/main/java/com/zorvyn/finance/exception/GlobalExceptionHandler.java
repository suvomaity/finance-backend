 ...
 * Without this, Spring returns its default error page which isn't useful for API clients.
 */
...
public class GlobalExceptionHandler {
    ...
    // extracts field-level validation errors into a readable map
    ...
    public ResponseEntity<ApiResponse<Void>> handleGeneric(Exception ex) {
        // TODO: add proper logging here (slf4j) instead of exposing error message
